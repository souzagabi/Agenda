...
$id = $_GET['id'];
class TesourariaController extends AbstractController {

    public function __construct() {
        $this->entity = "Pessoa\Entity\Tesouraria";
        $this->service = "Pessoa\Service\TesourariaService";
        $this->form = "Pessoa\Form\TesourariaForm";
        $this->controller = "tesouraria";
    ...
    public function inserirAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                echo "o erro está aqui, o formulário não é válido";
                return $this->redirect()->toRoute($this->route, array('controller' => $this->controller, 'action' => 'inserir'));
            }
        }
