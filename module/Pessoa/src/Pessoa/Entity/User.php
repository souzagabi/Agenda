 ...
 * @ORM\Entity(repositoryClass="Pessoa\Entity\UserRepository")
 */
class User
{
    /**
    ...
    public function __construct(array $options = array()) {
        ...
        (new Hydrator\ClassMethods)->hydrate($options,$this); // recebe o array $options que é passado no construtor
        /*
