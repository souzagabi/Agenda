...
return array(
        ...
        'routes' => array(
            'classificacao' => array(
                ...
                'options' => array(
                    'route' => '/classificacao',
                    'defaults' => array(
                        'controller' => 'Classificacao\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
            'classificacao' => array(
                ...
                'options' => array(
                    'route' => '/classificacao',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Classificacao\Controller',
                        'controller' => 'Index',
                        'action' => 'index',
                    ),
                ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Classificacao\Controller\Index' => 'Classificacao\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
